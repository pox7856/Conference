...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_SET_PHOTO : function(aPhotoData){
		...
		try{
			...
			for(var i = 0; i <aPhotoData.length; i++){
				...
				//sContents += "<img src='"+ htData.sFileURL  +"' title='"+htData.sFileName+"' class='appedFile' id='"+htData.sFileURL+"'>";
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img src="{=sOriginalImageURL}" title="{=sName}" onclick="{=callback}(this)" >';
