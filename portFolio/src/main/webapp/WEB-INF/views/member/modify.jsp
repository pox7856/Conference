...
<!-- Dropzone.js -->
<link
	href="${contextPath}/resources/template/vendors/dropzone/dist/min/dropzone.min.css"
	rel="stylesheet">
<!-- 임시 이미지 테스트 스타일... -->
<!-- page content -->
	...
	<div class="">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_content">
						<form class="form-horizontal form-label-left " id='modify-form'
							action="/member/modify?${_csrf.parameterName}=${_csrf.token}"
							enctype="multipart/form-data" method="POST">
							<span class="section">멤버수정페이지</span>
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input name="username" class="form-control col-md-7 col-xs-12"
										id='username' placeholder="id.." value="${modify.name}"
										required="required"> <span id="dupleResult"></span>
								</div>
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input name="password" id="password" value="${modify.name}"
							...
							<div class="item form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input name="email" required="required" value="${modify.email}"
							...
							<div class="item form-group">
								<div class="col-md-6 col-md-offset-3">
									<button id="modifyBtn" class="btn btn-success">회원수정</button>
...
<script
	src="${contextPath}/resources/template/vendors/dropzone/dist/min/dropzone.min.js"></script>
